class Challenger : SteamLoco
{
    private string _trainInfo;
    public Challenger(string loco, int year, string trainInfo)
    ...
    {
        return $"Union Pacific 3985 visited the Quad Cities on November 19, 2022 while in a special hospital train \n"
        + "to Silvis, Illinois. The train started in Cheyenne, Wyoming on November 11 and took 9 days despite a few \n"
        + $"issues that happened along the way such as 5511, another steam engine needing constant maintenance and issues in\n"
        ...
        + $"the late afternoon before reaching Silvis at the former Rock Island shops where 3985 would undergo a rebuild to return\n"
        + $"her to service. ";
    }
